...
////////////////////////////////////////////////////////////////////////////
// 
// 			OK = pDevice->CreateDepthStencilState(&DSD, &r_Depth_Stencil_State_Z_ON);  OK == ("CreateDepthStencilView error");	// — глубиной
// 
// 			DSD.DepthEnable = false;
// 
// 			OK = pDevice->CreateDepthStencilState(&DSD, &r_Depth_Stencil_State_Z_OFF); OK == ("CreateDepthStencilView error");		// Ѕез глубины
    ...
    IMPL_CALL bool gpu_api_init_blenders    ()
    {
        ...
        BD.AlphaToCoverageEnable  = FALSE;	// мультисеплинга перекрывающихс€ полупрозрачных полигонов типа густой листвы или травы
        BD.IndependentBlendEnable = FALSE;	// если FALSE то используетс€ только 1 элемент массива параметров смешивани€, остальные 7 игнорируютс€
